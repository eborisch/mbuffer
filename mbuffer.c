...
static int
	...
	Hashers = 0, Direct = 0, SetOutsize = 0, TapeAware = 0;
static long
...
static volatile int ActSenders = 0;
...
static void searchOptionV(int argc, const char **argv)
{
	int c;
	for (c = 1; c < argc; c++) {
...
{
	int optMode = O_EXCL;
	int optMset = 0, optSset = 0, optBset = 0, watchdogStarted = 0;
	int numstdout = 0;
	long mxnrsem;
	int c, fl, err;
	sigset_t signalSet;
